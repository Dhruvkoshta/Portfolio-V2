...
function Footer() {
    ...
    emailJs
      .send(
        ...
        "template_rtsxsyv",
        {
          ...
          to_email: "koshtadhruv04@gmail.com",
  ...
  return (
    <footer
      ...
      style={{ backgroundColor: "rgb(4,9,22)" }}
    >
      <div className="p-4">
            ...
            <div className="col-lg-6 col-md-12 mb-4 mb-md-0 form-comtainer">
              <div className="form-style-6">
                ...
                <form name="form1" onSubmit={handleSubmit}>
                  ...
                  <div id="main">
                    <button id="lnch" type="submit" value="Send">
                      Send
                    </button>
                    <div id="lnch_btn">
      ...
      <div className="rounded-social-buttons tag">
        <a
          ...
          style={{ backgroundColor: "rgb(0 19 68)" }}
        >
        ...
        >
          ...
          <svg
            className="linkedin-icon-footer feather feather-linkedin"
            xmlns="http://www.w3.org/2000/svg"
            width="35"
            viewBox="0 0 24 24"
            fill="#0e76a8"
        ...
        <a
          ...
          href="https://www.instagram.com/it.s.dhruv/"
          style={{ backgroundColor: "rgb(0 19 68)" }}
        >
