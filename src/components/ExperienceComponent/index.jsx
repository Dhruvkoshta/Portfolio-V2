	...
	return (
		<>
				...
				<section style={{ height: "90vh" }}>
					<div className='container-fluid px-3 pt-5'>
						<div className='row mx-auto'>
							...
							<div
								className='px-md-5 p-3 col-md-6 d-flex flex-column align-items-center justify-content-center '
								data-aos='fade-left'
								data-aos-easing='linear'
								data-aos-duration='1200'
							>
								<h2 className='dropdown1 main-heading mb-0 education_head'>
									Educational <span className='edu_background'>Background</span>
								</h2>
								<p className='dropdown2 pre-heading font-weight-bolder text-center '>
			...
			<section className='s2'>
				<div className='container-sm  edSection'>
					<div className='conatiner text-center mb-5'>
						<h1 className='head'>
							Formal <span className='edu_background'>Education</span>
						</h1>
					</div>
				</div>
			</section>
				...
				<div className='container'>
					...
					<div className='timeline-item'>
						...
						<div className='timeline-content js--fadeInLeft'>
							<div
								...
								style={{
									backgroundImage:
										'url("/images/education-page/edTimeline1.png")',
									backgroundRepeat: "no-repeat",
									backgroundSize: "auto",
								}}
							/>
							<div className='date date1'>2023-27</div>
							<div>
								<h3 className='timelineHeading'>
									Bachelors of Enginnering, Electronics &amp; Communication
									Engineering
								</h3>
								<li>Currently in the process of graduation</li>
								<li>Made more than 25 Project with fiverr clients</li>
								<li>Continously Learning and Improving</li>
							</div>
						</div>
					</div>
					{/* Second */}
						...
						<div className='timeline-content timeline-card js--fadeInRight'>
							<div>
								<div
									...
									style={{
										backgroundImage:
											'url("/images/education-page/edTimeline2.png")',
										backgroundRepeat: "no-repeat",
										backgroundSize: "auto",
							...
							<div className='date date2'>2022-to date</div>
							<div className='alignment'>
								<h3 className='timelineHeading2'>Freelancing</h3>
								<h6>
									Started Freelancing at:
									<a
										href=' https://www.fiverr.com/dhruvkoshta'
										style={{
								...
								<li>Made few projects on the platform</li>
								<li>Learned Communication Skills with Clients</li>

								<li>Collabrated with many people to make good projects</li>
							</div>
						</div>
					</div>
					{/* Third */}
					<div className='timeline-item'>
						...
						<div className='timeline-content timeline-card js--fadeInRight'>
							...
							<div className='date date2'>2020-to date</div>
							<div className='alignment'>
								<h2 className='timelineHeading2'>Learning Web Development</h2>
								<h6>
									Started my journey in the field of Programming and Computer
									Science
								</h6>
								<li>Learned Basics of Web Development</li>
								<li>Learned Basics of Data Structures and Algorithms</li>

								<li>Moved towards more advanced topics with React</li>
							</div>
						</div>
					</div>
					{/* Fourth */}
					<div className='timeline-item'>
						...
						<div className='timeline-content js--fadeInLeft'>
							<div
								...
								style={{
									backgroundImage:
										'url("/images/education-page/edTimeline3.png")',
									backgroundRepeat: "no-repeat",
									backgroundSize: "auto",
								}}
							/>
							<div className='date date3'>2007-2022</div>
							<div className='align-third'>
								<h2 className='timelineHeading3'>
									Little Kingdom School Jabalpur
								</h2>
								<h6>High School</h6>
								<li>Top in the Class</li>
								<li>One of the Best Student</li>
								<li>Invested in Learning</li>
							</div>
						</div>
					</div>
				</div>
			...
			{/*MOOCs Cards*/}
			<div id='mooc' className='container-fluid'>
				<h4
					className='text-center pb-2 pt-5'
					data-aos='fade-up'
					data-aos-delay={300}
				>
					Online <span className='edu_background'>Accreditations</span>
				</h4>
				<div className='row moocs'>{/* Dynamic MOOCs Cards */}</div>
			</div>
		</>
	);
}
